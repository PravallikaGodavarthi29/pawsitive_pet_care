...
const https = require("https"); // Add this line if you want to use https
...
// Remove this part if you're only using the express server
// If you want to use https, configure it properly with SSL certificates
